<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="documentacionHipotecaPFAE.aspx.cs" Inherits="solucionesFinancieras.documentacionHipotecaPFAE" %>
                        ...
                        <form id="example-form" action="#" class="m-t-40">
                            <div>
                                ...
                                <section>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="userName">Identificación Oficial (INE o Pasaporte)</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p></p>
                                            <label for="userName">Acta de matrimonio (en su caso)</label>
                                            <div class="custom-file">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="userName">Recibos de nómina 3 últimos meses.</label>
                                            <div class="custom-file">
                                        ...
                                        <div class="col-md-6">
                                            <label for="userName">Estados de cuenta de los últimos 3 meses donde se refleje el depósito de la nómina.</label>
                                            <div class="custom-file">
