<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="documentacionPYMEF.aspx.cs" Inherits="solucionesFinancieras.documentacionPYMEF" %>
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body wizard-content">
                        ...
                        <form id="exampleform" action="#" class="m-t-40">
                            ...
                            <div>
                                ...
                                <section>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="validatedCustomFile1" runat="server"/>
                                    ...
                                    <h3>Representante legal y/o obligado solidario</h3>
                                    <div class="row">
                                        <div class="col-md-6">
                                ...
                                <section>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <label for="name2">Constancia Situación Fiscal no mayor a 1 mes</label>
                                                    <input id="name2" name="name" type="text" class="form-control" placeholder="nombre del archivo.extension"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <%--<asp:Button runat="server" Text="Ver Archivo" CssClass="btn btn-p"/>--%>
                                                    <br />
                                                    <button class="btn btn-sm btn-info" title="Ver documento">
                                                        <i class="fas fa-eye"></i>
                                                    </button>
                                                    <button class="btn btn-sm btn-info" title="Agregar nuevo Documento">
                                                        <i class="fas fa-file-alt"></i>
                                                    </button>
                                                    <button class="btn btn-sm btn-success" title="Archivo Correcto">
                                                        <i class="fa fa-check"></i>
                                                    </button>
                                                    <button class="btn btn-sm btn-danger" title="Archivo Incorrecto">
                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <label for="surname2">Comprobante de Domicilio no mayor a 1 mes</label>
                                                    <input id="surname2" name="surname" type="text" class="form-control"placeholder="nombre del archivo.extension"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <%--<asp:Button runat="server" Text="Ver Archivo" CssClass="btn btn-p"/>--%>
                                                    <br />
                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <label for="email2">Estados Financieros Año Anterior</label>
                                                    <input id="email2" name="email" type="text" class="email form-control"placeholder="nombre del archivo.extension"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <%--<asp:Button runat="server" Text="Ver Archivo" CssClass="btn btn-p"/>--%>
                                                    <br />
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <label for="name1">Estados Financieros Parciales no mayor a 3 meses</label>
                                                    <input id="name1" name="name" type="text" class="form-control"placeholder="nombre del archivo.extension"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <%--<asp:Button runat="server" Text="Ver Archivo" CssClass="btn btn-p"/>--%>
                                                    <br />
                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <label for="surname1">Declaración y Acuse año anterior</label>
                                                    <input id="surname1" name="surname" type="text" class="form-control"placeholder="nombre del archivo.extension"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <%--<asp:Button runat="server" Text="Ver Archivo" CssClass="btn btn-p"/>--%>
                                                    <br />
                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <label for="email1">Últimos 12 estados de cuenta PDF</label>
                                                    <input id="email1" name="email" type="text" class="email form-control"placeholder="nombre del archivo.extension"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <%--<asp:Button runat="server" Text="Ver Archivo" CssClass="btn btn-p"/>--%>
                                                    <br />
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <label for="name2">Identificación Oficial vigente</label>
                                                    <input id="name2" name="name" type="text" class="form-control" placeholder="nombre del archivo.extension"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <%--<asp:Button runat="server" Text="Ver Archivo" CssClass="btn btn-p"/>--%>
                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <label for="surname2">Acta de Matrimonio (Casado Separación de Bienes)</label>
                                                    <input id="surname2" name="surname" type="text" class="form-control"placeholder="nombre del archivo.extension"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <%--<asp:Button runat="server" Text="Ver Archivo" CssClass="btn btn-p"/>--%>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <label for="name1">Constancia Situación Fiscal no mayor a 1 meses</label>
                                                    <input id="name1" name="name" type="text" class="form-control"placeholder="nombre del archivo.extension"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <%--<asp:Button runat="server" Text="Ver Archivo" CssClass="btn btn-p"/>--%>
                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <label for="surname1">Comprobante de Domicilio no mayor a 1 meses</label>
                                                    <input id="surname1" name="surname" type="text" class="form-control"placeholder="nombre del archivo.extension"/>
                                                </div>
                                                <div class="col-md-3">
                                                    <%--<asp:Button runat="server" Text="Ver Archivo" CssClass="btn btn-p"/>--%>
