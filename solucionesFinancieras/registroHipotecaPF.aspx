<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registroHipotecaPF.aspx.cs" Inherits="solucionesFinancieras.registroHipotecaPF" %>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Registro Leads </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Hipotecario </span></a>
                                    <ul aria-expanded="false" class="collapse  first-level">
                                        <li class="sidebar-item"><a href="registroHipotecaPF.aspx" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu">Persona Física </span></a></li>
                                        <li class="sidebar-item"><a href="registroHipotecaPF.aspx" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> Persona Moral </span></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
